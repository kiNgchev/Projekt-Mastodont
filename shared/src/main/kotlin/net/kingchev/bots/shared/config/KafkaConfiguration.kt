...
private fun consumerProps(): MutableMap<String, Any> = buildMap {
    ...
    JacksonJsonDeserializer.TRUSTED_PACKAGES to "net.kingchev.model"
}
...
private fun <E : Any> kafkaListenerContainerFactory(consumer: ConsumerFactory<String, E>): KafkaListenerContainerFactoryBuilder<String, E> = {
    @Suppress("UsePropertyAccessSyntax")
    setConsumerFactory(consumer)
